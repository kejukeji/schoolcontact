...
def response_event(xml_recv, web_chat):
    ...
    Content = '您还没绑定点击此连接进行<a href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx55970915710ceae8&redirect_uri=http%3A%2F%2Fschool.kejukeji.com%2Foauth%3FFromUserName%3D'+FromUserName+'&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect">绑定</a>'
